...
namespace Auto.Common.Entities
{
	...
	public partial class nav_credit : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<decimal> nav_percent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<decimal>>("nav_percent");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Nullable<Auto.Common.Entities.nav_creditState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.Entities.nav_creditState)(System.Enum.ToObject(typeof(Auto.Common.Entities.nav_creditState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.nav_agreement> nav_nav_credit_nav_agreement_creditid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.nav_agreement>("nav_nav_credit_nav_agreement_creditid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_credit_nav_agreement_creditid");
				this.SetRelatedEntities<Auto.Common.Entities.nav_agreement>("nav_nav_credit_nav_agreement_creditid", null, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.nav_auto> nav_nav_credit_nav_auto
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.nav_auto>("nav_nav_credit_nav_auto", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_credit_nav_auto");
				this.SetRelatedEntities<Auto.Common.Entities.nav_auto>("nav_nav_credit_nav_auto", null, value);
