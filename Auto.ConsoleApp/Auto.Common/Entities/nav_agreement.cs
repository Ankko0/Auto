...
namespace Auto.Common.Entities
{
	...
	public partial class nav_agreement : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<decimal> nav_creditperiod
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<decimal>>("nav_creditperiod");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Nullable<Auto.Common.Entities.nav_agreementState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.Entities.nav_agreementState)(System.Enum.ToObject(typeof(Auto.Common.Entities.nav_agreementState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.nav_invoice> nav_nav_agreement_nav_invoice_dogovorid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.nav_invoice>("nav_nav_agreement_nav_invoice_dogovorid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_agreement_nav_invoice_dogovorid");
				this.SetRelatedEntities<Auto.Common.Entities.nav_invoice>("nav_nav_agreement_nav_invoice_dogovorid", null, value);
		...
		public Auto.Common.Entities.Contact nav_contact_nav_agreement_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entities.Contact>("nav_contact_nav_agreement_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_agreement_contactid");
				this.SetRelatedEntity<Auto.Common.Entities.Contact>("nav_contact_nav_agreement_contactid", null, value);
		...
		public Auto.Common.Entities.nav_auto nav_nav_auto_nav_agreement_autoid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entities.nav_auto>("nav_nav_auto_nav_agreement_autoid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_auto_nav_agreement_autoid");
				this.SetRelatedEntity<Auto.Common.Entities.nav_auto>("nav_nav_auto_nav_agreement_autoid", null, value);
		...
		public Auto.Common.Entities.nav_credit nav_nav_credit_nav_agreement_creditid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entities.nav_credit>("nav_nav_credit_nav_agreement_creditid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_credit_nav_agreement_creditid");
				this.SetRelatedEntity<Auto.Common.Entities.nav_credit>("nav_nav_credit_nav_agreement_creditid", null, value);
