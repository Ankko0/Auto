...
namespace Auto.Common.Entities
{
	...
	public partial class nav_invoice : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Auto.Common.Entities.nav_invoiceState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.Entities.nav_invoiceState)(System.Enum.ToObject(typeof(Auto.Common.Entities.nav_invoiceState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Auto.Common.Entities.nav_agreement nav_nav_agreement_nav_invoice_dogovorid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entities.nav_agreement>("nav_nav_agreement_nav_invoice_dogovorid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_agreement_nav_invoice_dogovorid");
				this.SetRelatedEntity<Auto.Common.Entities.nav_agreement>("nav_nav_agreement_nav_invoice_dogovorid", null, value);
