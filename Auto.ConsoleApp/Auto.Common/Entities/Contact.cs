...
namespace Auto.Common.Entities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>
		/// 1:N nav_contact_nav_agreement_contactid
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("nav_contact_nav_agreement_contactid")]
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.nav_agreement> nav_contact_nav_agreement_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.nav_agreement>("nav_contact_nav_agreement_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_agreement_contactid");
				this.SetRelatedEntities<Auto.Common.Entities.nav_agreement>("nav_contact_nav_agreement_contactid", null, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.nav_communication> nav_contact_nav_communication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.nav_communication>("nav_contact_nav_communication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_communication_contactid");
				this.SetRelatedEntities<Auto.Common.Entities.nav_communication>("nav_contact_nav_communication_contactid", null, value);
